...
#include "../../Ragnarok/levelwindow.h"
...
QT_MOC_LITERAL(1, 12, 3), // "fin"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 1), // "x"
QT_MOC_LITERAL(4, 19, 17), // "ChangeLevelSignal"
QT_MOC_LITERAL(5, 37, 7), // "closeMe"
QT_MOC_LITERAL(6, 45, 9), // "SaveMatch"
QT_MOC_LITERAL(7, 55, 11) // "ChangeLevel"

    },
    "LevelWindow\0fin\0\0x\0ChangeLevelSignal\0"
    "closeMe\0SaveMatch\0ChangeLevel"
};
...
void LevelWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ChangeLevelSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->closeMe(); break;
        case 3: _t->SaveMatch(); break;
        case 4: _t->ChangeLevel(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LevelWindow::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LevelWindow::fin)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LevelWindow::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LevelWindow::ChangeLevelSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void LevelWindow::ChangeLevelSignal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
